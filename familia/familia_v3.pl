...
/* Para todo A e B, A é antepassado de B, se existe um X tal que A é progenitor de X e X é antepassado de B */
antepassado(A,B) :- progenitor(A,B); progenitor(A,X), antepassado(X,B).
/* Para todo A e B, A é descendente de B, se existe um X tal que A é progenitor de X e X é descente de B */
descendente(A,B) :- progenitor(A,B); progenitor(A,X), descendente(X,B).